...
// api/profile.js
var PLAYERDB_PROFILE_URL = "https://playerdb.co/api/player/minecraft/";
var REWARDS_URL = "https://rewards.vaulthunters.gg/rewards?minecraft=";
var TIER_URL = "https://api.vaulthunters.gg/users/reward?uuid=";
var INVALID_UUID_LENGTH = 32;
var REQUEST_HEADERS = {
...
__name(fetchRewards, "fetchRewards");
...
var ALLOWED_IMAGE_HOSTS = /* @__PURE__ */ new Set(["wiki.vaulthunters.gg", "mc-heads.net"]);
async function onRequest2({ request }) {
  try {
    ...
    const headers = {
      "user-agent": REQUEST_HEADERS2["user-agent"],
    ...
    if (upstream.status === 304) {
      ...
      const etag2 = upstream.headers.get("etag");
      const lastMod2 = upstream.headers.get("last-modified");
      if (etag2) h.set("etag", etag2);
      if (lastMod2) h.set("last-modified", lastMod2);
      h.set("vary", "Accept");
...
// ../.wrangler/tmp/pages-orwaF5/functionsRoutes-0.07200437848484054.mjs
var routes = [
  {
...
// C:/Users/samva/AppData/Local/npm-cache/_npx/38250d4860b830ac/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/samva/AppData/Local/npm-cache/_npx/38250d4860b830ac/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/samva/AppData/Local/npm-cache/_npx/38250d4860b830ac/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/samva/AppData/Local/npm-cache/_npx/38250d4860b830ac/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-swsUOC/middleware-insertion-facade.js
...
// C:/Users/samva/AppData/Local/npm-cache/_npx/38250d4860b830ac/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-swsUOC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6806110467440731.mjs.map
